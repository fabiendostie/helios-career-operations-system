...
class MockResponseGenerator:
    ...
    @staticmethod
    def profile_ingestor_success_response(profile_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "processing_time": 2.3,
            "data": {
                "skills_extracted": len(profile_data.get("skills_inventory", {}).get("programming_languages", [])),
                "experience_years": MockResponseGenerator._calculate_experience_years(profile_data),
                "education_level": MockResponseGenerator._determine_education_level(profile_data),
    ...
    @staticmethod
    def profile_ingestor_error_response(error_type: str = "parsing_failed") -> Dict[str, Any]:
    ...
    @staticmethod
    def strategist_success_response(profile_data: Dict[str, Any], career_goals: Dict[str, Any]) -> Dict[str, Any]:
        """Generate successful strategist response."""
        skills = profile_data.get("skills_inventory", {})
        experience_years = MockResponseGenerator._calculate_experience_years(profile_data)

        career_paths = MockResponseGenerator._generate_career_paths(skills, experience_years, career_goals)

        return {
            "status": "success",
            "career_paths": career_paths,
            "analysis": {
                "current_level": MockResponseGenerator._determine_current_level(experience_years),
                "skill_gaps": MockResponseGenerator._identify_skill_gaps(skills, career_goals),
                "market_alignment": 0.82,
                "growth_potential": 0.78
            },
            "recommendations": {
                "priority_skills": ["System Design", "Leadership", "Cloud Architecture"],
    ...
    @staticmethod
    def strategist_error_response(error_type: str = "insufficient_data") -> Dict[str, Any]:
    ...
    def analyst_success_response(profile_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "market_analysis": {
                ...
                "hot_skills": ["Kubernetes", "Machine Learning", "System Design", "TypeScript"],
                "market_size": {
                    "total_jobs": 45000,
            ...
            "resume_optimization": {
                ...
                "suggested_keywords": ["microservices", "cloud-native", "DevOps", "API design"],
    ...
    @staticmethod
    def analyst_error_response(error_type: str = "market_data_unavailable") -> Dict[str, Any]:
        ...
        return error_responses.get(error_type, error_responses["market_data_unavailable"])
    ...
    @staticmethod
    def orchestrator_status_response(session_id: str, workflow_progress: int = 0) -> Dict[str, Any]:
        """Generate orchestrator status response."""
        stages = ["profile_ingestion", "career_analysis", "market_analysis", "recommendations"]
        completed_stages = stages[:workflow_progress // 25] if workflow_progress > 0 else []

        return {
            "status": "active" if workflow_progress < 100 else "completed",
            "session_id": session_id,
            "workflow_progress": workflow_progress,
            "current_stage": stages[len(completed_stages)] if len(completed_stages) < len(stages) else "completed",
    ...
    @staticmethod
    def _generate_career_paths(skills: Dict[str, Any], experience_years: float, career_goals: Dict[str, Any]) -> List[Dict[str, Any]]:
        ...
        base_paths = [
            ...
            },
            {
                ...
                "probability": 0.72,
                "timeline_months": 24,
                "required_skills": ["Team Leadership", "Project Management", "Technical Strategy"],
            ...
            },
            {
                ...
                "probability": 0.68,
                "timeline_months": 30,
                "required_skills": ["Architecture Design", "Cross-team Influence", "Technical Vision"],
        ...
        if experience_years < 3:
            ...
            base_paths[0]["salary_range"] = {"min": 90000, "max": 140000, "currency": "USD"}

        return base_paths

    @staticmethod
    def _identify_skill_gaps(current_skills: Dict[str, Any], career_goals: Dict[str, Any]) -> List[str]:
        ...
        target_skills = {
            "System Design", "Leadership", "Cloud Architecture",
            "Kubernetes", "Machine Learning", "Distributed Systems"
        }
